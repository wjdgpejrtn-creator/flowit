...
# critique가 채점하는 8개 루브릭 차원(각 항목 0~2점). refine이 끌어올릴 결함을 드러낸다.
_RUBRIC_DIMENSIONS = (
...
def build_critique_prompt(skill_name: str, draft_instructions: str) -> str:
    """초안 SKILL.md를 8개 루브릭으로 채점·결함 지적시키는 프롬프트(자유 텍스트 응답).
    ...
    return (
        ...
        f"아래 '{skill_name}' 스킬의 SKILL.md 초안을 다음 8개 기준으로 각 0~2점 채점하고, "
