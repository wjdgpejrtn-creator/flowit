...
| `skills` | `app/routers/skills.py` | `POST /skills/{id}/approve`, `POST /skills/{id}/publish` | `skills_marketplace` ApproveSkill/PublishSkill — scope-aware 게시 lifecycle (ADR-0020 Q4). submit(DRAFT→REVIEW)은 `SubmitSkillUseCase` 신설 후 추가 |
