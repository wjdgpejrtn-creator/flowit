...
CREATE OR REPLACE TRIGGER set_skill_reviews_updated_at
    BEFORE UPDATE ON skill_reviews
    FOR EACH ROW EXECUTE FUNCTION trigger_set_updated_at();

CREATE UNIQUE INDEX IF NOT EXISTS idx_skill_reviews_skill_user ON skill_reviews(skill_id, user_id);
...
CREATE INDEX IF NOT EXISTS idx_marketplace_recommendations_user_id
