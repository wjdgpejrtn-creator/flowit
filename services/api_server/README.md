...
>
> 구현 명세 → [`docs/specs/REQ-009-api_server.md`](../../docs/specs/REQ-009-api_server.md)
...
Upstream (이 서비스가 의존 — Use Case 호출):
  ...
  ├── common_schemas (REQ-012) → 모든 DTO/응답 모델
  └── execution_engine (REQ-007) → Celery task dispatch
