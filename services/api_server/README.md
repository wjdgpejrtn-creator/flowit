...
| `auth` | `GET /auth/{authorize,callback,me}`, `POST /auth/{login,refresh,logout}` | REQ-002 Authenticate/RefreshToken UseCase — ADR-0021 HttpOnly 쿠키 인증 (callback 302 + refresh/logout 쿠키 기반) |
