...
grep -rn "<symbol>" modules/ services/ packages/

# 4) 대응 테스트 파일
find modules/*/tests services/*/tests -name "test_*<module>*"
```
...
### 5. API / 인터페이스 설계
- [ ] 함수 시그니처 변경이 호출처와 호환되는지 (Step 0 grep 결과 대조)
...
4. Performance — 수행: ... / 발견: ...
5. API 설계 — 수행: ... / 발견: ...
6. Clean Architecture 의존성 — 수행: ... / 발견: ...
7. Readability — 수행: ... / 발견: ...
8. 보안 위임 — SECURITY_AUDITOR 호출 필요: yes/no

[Findings]
- [Critical] <파일:라인> — <문제> — <근거(코드 경로/grep 결과)> — <권고 조치>
- [Major]    ...
- [Minor]    ...
